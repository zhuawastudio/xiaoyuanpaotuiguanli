               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="单价" prop="renwuMoney">
                       <el-input v-model="ruleForm.renwuMoney"
                                 placeholder="单价" clearable  :readonly="ro.renwuMoney"></el-input>
                   </el-form-item>
                   <div v-else>
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="任务详情" prop="renwuContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.renwuContent" label="任务详情" prop="renwuContent">
    ...
    export default {
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=renwu_status_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.renwuStatusTypesOptions = data.data.list;
                    }
                });
