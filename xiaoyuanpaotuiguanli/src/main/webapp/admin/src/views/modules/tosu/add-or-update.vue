    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="投诉标题" prop="tosuName">
                       <el-input v-model="ruleForm.tosuName"
                                 placeholder="投诉标题" clearable  :readonly="ro.tosuName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="投诉标题" prop="tosuName">
                           <el-input v-model="ruleForm.tosuName"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="投诉类型" prop="tosuTypes">
                        <el-select v-model="ruleForm.tosuTypes" :disabled="ro.tosuTypes" placeholder="请选择投诉类型">
                            <el-option
                                v-for="(item,index) in tosuTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="投诉类型" prop="tosuValue">
                        <el-input v-model="ruleForm.tosuValue"
                            placeholder="投诉类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="投诉原因" prop="tosuText">
                        <el-input type="textarea"  :readonly="ro.tosuText" v-model="ruleForm.tosuText" placeholder="投诉原因"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.tosuText" label="投诉原因" prop="tosuText">
                            <span v-html="ruleForm.tosuText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=tosu_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.tosuTypesOptions = data.data.list;
                    }
                });
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=tosu_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.tosuYesnoTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`tosu/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.tosuCrossAddOrUpdateFlag = false;
                                        this.parent.search();
